            ...
            <div class="col-lg-4 col-6 text-left">
                <form action="">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="Search for cards">
                        <div class="input-group-append">
                            <span class="input-group-text bg-dark text-primary">
            ...
            <div class="col-lg-3 d-none d-lg-block">
                ...
                <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 bg-light" id="navbar-vertical" style="width: calc(100% - 30px); z-index: 999;">
                    <div class="navbar-nav w-100">
                        <a href="" class="nav-item nav-link">Cards</a>
                        <a href="" class="nav-item nav-link">Boosters</a>
                        <div class="nav-item dropdown dropright">
                            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Acessories <i class="fa fa-angle-right float-right mt-1"></i></a>
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="shop.html" class="nav-item nav-link">Magic</a>
                            <a href="detail.html" class="nav-item nav-link">Pokémon</a>
                            <a href="contact.html" class="nav-item nav-link">One Piece</a>
