...
<div class="mt-5">
    <h2 class="text-center mb-4">Sale Details</h2>
    <div class="rounded bg-light p-4">
        <h3 class="mt-4">Listing</h3>
        <?php if (!empty($item)): ?>
            ...
            <table class="table table-bordered col-6">
                ...
                <tbody>
                <tr>
                    <td class="col-3" title="Satuts"><?= Html::encode(($item['buyer']->username)) ?></td>
